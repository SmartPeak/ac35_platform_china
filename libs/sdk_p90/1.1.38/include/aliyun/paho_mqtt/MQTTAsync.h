...
/**
 * Return code: Malloc memory failed.
 */
#define MQTTASYNC_NO_MEMORY -14
...
//void PAHO_MQTTAsync_pub_Unit_Test(char *result, char *judge_style);
//void PAHO_MQTTAsync_sub_Unit_Test(char *result, char *judge_style);
//void PAHO_MQTTAsync_Unit_Test(char *result, char *judge_style);
//void MQTTAsync_init_syncobjs(void);
